...
banners = {
    "banner1": {
        ...
        "category": "info",
        "active": True,
        "start_datetime": datetime(2022, 7, 20).isoformat(),
        "end_datetime": datetime(2023, 1, 29).isoformat(),
    },
    "banner2": {
        "message": "banner2",
        "url_path": "/banner2",
        "category": "other",
        "active": False,
        "start_datetime": datetime(2022, 12, 15).isoformat(),
        "end_datetime": datetime(2023, 1, 5).isoformat(),
    },
    "banner3": {
        "message": "banner3",
        "url_path": "/banner3",
        "category": "warning",
        "active": True,
        "start_datetime": datetime(2023, 1, 20).isoformat(),
        "end_datetime": datetime(2023, 2, 25).isoformat(),
    },
}
